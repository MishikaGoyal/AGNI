...
export default function Page() {
  ...
  <div>
  <div>
    <video src="video3.mp4" className=' slide-in-elliptic-left-fwd w-[700px] absolute mt-[150px] ml-[360px] rounded-xl opacity-2' loop autoPlay muted></video>
  </div>
  <Navbar />
  <p className='tracking-in-expand-fwd mt-[20px] ml-[40px] text-xl'>The beautiful thing about learning is that no one can take it away from you</p>
...
<button className=" wobble-hor-bottom btn bg-blue-700 text-white" onClick={()=>document.getElementById('my_modal_1').showModal()}>Anaylse now</button>
<dialog id="my_modal_1" className="modal">
  <div className="modal-box">
    <h3 className="font-bold text-lg">Submit Report</h3>
    <input type="file" className="file-input file-input-bordered w-full max-w-xs mt-[20px]" />
