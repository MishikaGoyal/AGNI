  ...
  return (
    <navbar className="w-[100vh]">
      <div className="bg-gray-900 text-white h-[60px]">
        <ul className="">
          <li className="-ml-[100px] absolute">
              ...
              <div className="mt-[300px] ml-[200px] text-black">
                ...
                <div className="modal" role="dialog">
                  <div className="modal-box">
                    ...
                    <p className="py-4">
                      Structure: {selectedSchool.structure}
                    </p>
                    <p className="py-2">
                      Resources: {selectedSchool.resources}
                    </p>
          ...
          <li>
            <button className="ml-[1300px] mt-[10px] text-white hover:text-black hover:bg-white  p-2 ">
              Signout
            </button>
          </li>
        </ul>
